...
??? note "余談"
    来年の研究の参考のためなど、日本チームの参加者全員が発表をする訳ではない事は知っていましたが、早稲田本庄生から「発表はしたけど、誰も研究には全然関わっていない、なんなら文系」と言う話を聞いて、本当に驚きました。ポスターを見てみると、確かに Reference には過去の先輩の卒業論文だけ記載されているのが見て取れました。
